  ...
  return (
    <div className="bg-white min-h-screen flex  flex-col items-center justify-center px-[16px]  11xl-[100%]">
      <div className="w-full max-w-2xl mt-2 mb-2 space-y-12">
        <h2 className="text-5xl text-center text-black mb-4 mt-10 font-[Bembo-MT-Pro-Bold]">Frequently asked questions</h2>
        <p className="text-gray-400 mb-8 font-[Bembo-MT-Pro-Regular]">
